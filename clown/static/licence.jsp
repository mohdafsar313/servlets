    ...
    <center>
        <form action="licence" method="post">
            ...
            <div style="margin-bottom: 15px;">
                <label style="display: inline-block; width: 80px;">License:</label>
                <select name="licenseType" id="licenseType" style="width: 208px;">
                    <option value="">--Select Type--</option>
                    <option value="learning">Learning License</option>
                    <option value="permanent">Permanent License</option>
                    <option value="renewal">Renewal</option>
                    <option value="duplicate">Duplicate License</option>
                </select>
            </div>

            <input type="submit" value="Apply" style="padding: 5px 15px;">
        </form>
    </center>
</div>
