    ...
    <center>
        <form action="fir" method="post">
            ...
            <div style="margin-bottom: 10px;">
                <label style="display: inline-block; width: 80px;">Complaint Name:</label>
                <input type="text" placeholder="Enter the name" name="complaintname" style="width: 200px;">
            </div>

            <div style="margin-bottom: 10px;">
                <label style="display: inline-block; width: 80px;">date of incident:</label>
                <input type="date" placeholder=" " name="dateofincident" style="width: 200px;">
            </div>
            <div style="margin-bottom: 10px;">
                <label style="display: inline-block; width: 80px;">Location:</label>
                <input type="text" placeholder=" location of the incident" name="location" style="width: 200px;">
            </div>
