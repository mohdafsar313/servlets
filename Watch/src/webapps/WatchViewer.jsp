...
<head>
    <meta charset="UTF-8">
    <title>Watch Information Collector</title>
...
<div class="container py-5">
    ...
    <form action="search" method="get" class="row g-3">
        ...
        <div class="col-md-6">
            <label class="form-label">Watch Material</label>
            <input type="text" name="watchId" class="form-control" required placeholder="Enter Watch Id">
        </div>
